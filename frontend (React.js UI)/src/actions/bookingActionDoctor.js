export async function action({ request, params }) {
    ...
    console.log("Sending booking data:", date,username,doctorId);


    if (!date || !username || !doctorId) {
    ...
    try {
        ...
        const response = await fetch("https://carefirst-v1.runasp.net/api/Booking/CreateBookingForDoctor", {
            method: "POST",
            headers: {
